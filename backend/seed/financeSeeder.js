...
//     // Find clearances where faculty, library and lab are all approved
//     const clearedClearances = await Clearance.find({
//       'faculty.status': 'Approved',
//       'library.status': 'Approved',
//       'lab.status': 'Approved'
//     }).select('studentId');

//     // Extract student IDs from clearance records
//     const clearedStudentIds = clearedClearances.map(c => c.studentId);

//     // Fetch students who cleared phase one
//     const students = await Student.find({ _id: { $in: clearedStudentIds } });

//     if (students.length === 0) {
//       console.log('❌ No students found who cleared all phase one departments.');
//       process.exit(0);
//     }
